...
export interface JunoNftMarketplaceXReadOnlyInterface {
...
export class JunoNftMarketplaceXQueryClient implements JunoNftMarketplaceXReadOnlyInterface {
...
export interface JunoNftMarketplaceXInterface extends JunoNftMarketplaceXReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receiveNft: ({
    msg,
...
export class JunoNftMarketplaceXClient extends JunoNftMarketplaceXQueryClient implements JunoNftMarketplaceXInterface {

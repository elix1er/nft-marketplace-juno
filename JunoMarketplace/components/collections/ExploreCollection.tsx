...
// collections, true, collectionLoader
  ...
  // const { jMarketplace } = useContracts();
  
  // let marketQuery = jMarketplace.getQueryClient(CHAIN_MARKETPLACE_ADDRESS)

  // let marketSigner = jMarketplace.getSigningClient(CHAIN_MARKETPLACE_ADDRESS)
  
  // let jMarketstateQ = useJMarketplaceStateQuery({client: marketQuery })
  // let jMarketMsgComp = jMarketplace.getMessageComposer(CHAIN_MARKETPLACE_ADDRESS);
  
  // useEffect(() => {
  //     const fetchData = async () => {
  //         try {
  //             let colData = await marketQuery.state();
  //             console.log(colData);
  //         } catch (error) {
